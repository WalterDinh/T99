...
import { T99investParamList } from 'app/presentation/navigation/routes/routeParams';
...
interface IProps {
    navigation: StackNavigationProp<T99investParamList, 'T99Invest'>;
...
const index = (props: IProps) => {
    ...
    const data = {
        ...
        period: `${dataLoanFee?.loanTime} ${dataLoanFee?.period || 'Tháng'}`,
        ...
        dayTransaction: dayjs(additionalInformation?.dayTransaction)?.format(
                    ...
                    navigation.replace('T99doneProduct', {
                        ...
                        titleContent: (
                            <TextPrimary style={styles.titleContent}>
                                ...
                                <TextPrimary
                                    onPress={()=>{LinkingHelper.phoneCall(HOTLINE)}}
