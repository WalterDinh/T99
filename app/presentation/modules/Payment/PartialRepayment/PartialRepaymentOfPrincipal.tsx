...
import { stylesPartialRepayment } from './style';
interface IProps {
    navigation: StackNavigationProp<HomeStackParamList, 'PartialRepayment'>;
}
const PartialRepayment = (props: IProps) => {
    const { navigation } = props;

    const renderItem = ({ item, index }: any) => {
        return (
            <CommonCard
                onPress={() => navigation.navigate('PartialRepaymentDetail')}
                styleCommonCard={stylesPartialRepayment.formItem}
                key={index}
